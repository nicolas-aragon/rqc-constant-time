...
/**
 * \fn void rbc_43_vec_set_random(random_source*, rbc_43_vec v, uint32_t size)
 ...
 * \param[in] size Size of the vector
 */
void rbc_43_vec_set_random(random_source* ctx, rbc_43_vec v, uint32_t size) {
 ...
 * \param[in] size Size of the vector
 */
void rbc_43_vec_set_random_tmp(seedexpander_shake_t* ctx, rbc_43_vec v, uint32_t size) {
  uint32_t bytes = (RBC_43_FIELD_M % 8 == 0) ? RBC_43_FIELD_M / 8 : RBC_43_FIELD_M / 8 + 1;
  uint8_t random[size * bytes];
  uint8_t mask = (1 << RBC_43_FIELD_M % 8) - 1;
...
/**
 * \fn void rbc_43_vec_set_random_from_xof(rbc_43_vec o, uint32_t size, void (*xof)(uint8_t *, size_t, const uint8_t *, size_t), const uint8_t *xof_input, uint32_t xof_size)
...
/**
 * \fn void rbc_43_vec_set_random_fixed_rank(random_source* ctx, rbc_43_vec o, uint32_t size)
...
void rbc_43_vec_set_random_fixed_rank(random_source* ctx, rbc_43_vec o, uint32_t size, int32_t rank) {
  ...
  while(fixed_rank != rank) {
    rbc_43_vec_set_random(ctx, o, size);
    fixed_rank = rbc_43_vec_get_rank(o, size);
  }
}
...
/**
 * \fn void rbc_43_vec_set_random_full_rank(random_source* ctx, rbc_43_vec o, uint32_t size)
 ...
 * \param[in] size Size of the vector
 */
void rbc_43_vec_set_random_full_rank(random_source* ctx, rbc_43_vec o, uint32_t size) {
...
/**
 * \fn void rbc_43_vec_set_random_full_rank_with_one(random_source* ctx, rbc_43_vec o, uint32_t size) {
...
void rbc_43_vec_set_random_full_rank_with_one_tmp(seedexpander_shake_t* ctx, rbc_43_vec o, uint32_t size) {
  ...
  while(rank != rank_max) {
    rbc_43_vec_set_random_tmp(ctx, o, size - 1);
    rbc_43_elt_set_one(o[size - 1]);
    rank = rbc_43_vec_get_rank(o, size);
  }
}
...
/**
 * \fn void rbc_43_vec_set_random_from_support(random_source* o, rbc_43_vec o, uint32_t size, const rbc_43_vec support, uint32_t support_size)
...
/**
 * \fn uint32_t rbc_43_vec_echelonize(rbc_43_vec v, uint32_t size)
 ...
 * \return Rank of the vector <b>v</b>
 */
uint32_t rbc_43_vec_echelonize(rbc_43_vec v, uint32_t size) {
  uint32_t dimension = rbc_43_vec_gauss(v, size, 1, NULL, 0);
...
/**
 * \fn void rbc_43_vec_from_bytes_without_mask(rbc_43_vec o, uint32_t size, const uint8_t *random)
 * \brief This function sets a vector of finite field elements from random bytes.
 *
 * \param[out] v rbc_43_vec
 * \param[in] size Size of the vector
